...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 overflow-x-hidden">
            ...
            {/* Stats Section */}
            <section className="py-16 sm:py-20 border-y border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
            ...
            {/* Pricing Section */}
            <section id="pricing" className="py-20 sm:py-24 md:py-32 bg-slate-100/50 dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800">
                <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
